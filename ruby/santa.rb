class Santa
	...
	def initialize(gender_string, ethnicity_string, age = 0)
...
age_generator = Random.new
75.times do
  Santa.new(example_genders.sample, example_ethnicities.sample, age_generator.rand(140))
end
